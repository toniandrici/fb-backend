...
describe('AddReaction', () => {
  ...
  it('should send correct json response', async () => {
    ...
    const reactionSpy = jest.spyOn(reactionQueue, 'addAReactionJob');
    ...
    expect(reactionQueue.addAReactionJob).toHaveBeenCalledWith(reactionSpy.mock.calls[0][0], reactionSpy.mock.calls[0][1]);
